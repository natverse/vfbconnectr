# Getting help with vfbconnectr

Thanks for using vfbconnectr. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the vfbconnectr package](https://github.com/natverse/vfbconnectr/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/vfbconnectr/issues/new).
* If you're not sure:
